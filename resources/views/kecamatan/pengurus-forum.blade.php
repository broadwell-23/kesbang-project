    ...
    <div class="col-lg-12">
        <section class="panel">
           <header class="panel-heading">
              <i class="fa fa-database"></i> Data Pengurus @if($forums->tipe==0) <b>Forum</b> @else <b>LSM (Lembaga Swadaya Masyarakat)</b> @endif <strong style="color: red;">{{$forums->nama}}</strong>
            </header>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header" style="background-color: green;">
                  ...
                  <h4 class="modal-title">Tambah Pengurus @if($forums->tipe==0) <b>Forum</b> @else <b>LSM (Lembaga Swadaya Masyarakat)</b> @endif <strong>{{$forums->nama}}</strong></h4>
              </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">Ubah Data Pengurus @if($forums->tipe==0) <b>Forum</b> @else <b>LSM (Lembaga Swadaya Masyarakat)</b> @endif <strong>{{$forums->nama}}</strong></h4>
                </div>
                <div class="modal-body">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header" style="background-color: red;">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">Hapus Data @if($forums->tipe==0) <b>Forum</b> @else <b>LSM (Lembaga Swadaya Masyarakat)</b> @endif <strong>{{$forums->nama}}</strong></h4>
                </div>
                <div class="modal-body">
                  ...
                  <form method="POST">
                    ...
                    <center>
                      ...
                      <p><strong>Forum : {{$pengurus->forum->nama}}</strong> ?</p>
                    </center>

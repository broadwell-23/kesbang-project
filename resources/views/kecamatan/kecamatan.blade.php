...
<div class="row">
  	<div class="col-lg-12">
      	<section class="panel">
              ...
              <i class="fa fa-database"></i> Data Kecamatan
          	</header>
              ...
              <div class="container-fluid">
                ...
                <div class="adv-table">
                  <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-striped table-advance table-hover" id="Kecamatan">
                    <thead>
                      <tr>
                          <th>No</th>
                    ...
                    <tbody>
                      @foreach($kecamatans as $no => $kecamatan)
                      <tr>
                        <td>{{$no+1}}</td>
...
<!-- MODAL COLLECTIONS -->
  ...
  @foreach($kecamatans as $kecamatan)
    <!-- Modal ubah -->
    <div class="modal fade" id="modalUbah{{$kecamatan->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
    ...
    <!-- Modal hapus -->
    <div class="modal fade" id="modalHapus{{$kecamatan->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form method="POST">
                    ...
                    <center>
                      <p>Apakah anda yakin akan menghapus Kecamatan</p>
                      <p><strong>{{$kecamatan->nama}}</strong> ?</p>
                    </center>
